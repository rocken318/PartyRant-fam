              ...
              <div className="flex flex-col gap-2">
                {!hostShowInput ? (
                  <button
                    ...
                    className="w-full h-11 bg-white text-pf-dark font-bold text-sm rounded-[6px] border-[2px] border-pf-dark shadow-[2px_2px_0_#1A1A2E] active:shadow-[1px_1px_0_#1A1A2E] active:translate-x-[1px] active:translate-y-[1px] transition-[transform,box-shadow] duration-75 touch-manipulation"
                    style={{ fontFamily: 'var(--font-dm)' }}
                  >
                    ＋ ホストも参加する
                  </button>
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      maxLength={20}
                      autoFocus
                      className="flex-1 h-11 px-3 rounded-[6px] border-[2px] border-pf-dark text-pf-dark font-bold text-sm focus:outline-none"
                      style={{ fontFamily: 'var(--font-dm)' }}
                    />
                    <button
                      type="button"
                      ...
                      className="h-11 px-4 bg-pf-green text-white font-bold text-sm rounded-[6px] border-[2px] border-pf-dark shadow-[2px_2px_0_#1A1A2E] disabled:opacity-50 touch-manipulation"
                      style={{ fontFamily: 'var(--font-dm)' }}
                    >
                      {hostJoining ? '…' : '参加'}
                    </button>
          ...
          <>
            ...
            {hostParticipating && !hostAnswered && (
              <div className="flex flex-col gap-2 mt-2">
                <p className="text-xs font-bold text-gray-500 text-center">あなたの回答</p>
                  ...
                  <button
                    ...
                    className={[
                      ...
                      hostSelectedChoice === i
                        ? 'bg-pf-yellow text-pf-dark border-pf-dark shadow-[1px_1px_0_#1A1A2E]'
                        : 'bg-white text-pf-dark border-pf-dark shadow-[3px_3px_0_#1A1A2E] active:shadow-[1px_1px_0_#1A1A2E] active:translate-x-[1px] active:translate-y-[1px]',
                    ].join(' ')}
                    style={{ fontFamily: 'var(--font-dm)' }}
                  >
                    {opt}
                  ...
                  return (
                    <div className="flex flex-col gap-2 mt-2">
                      ...
                      {personResults.map((r, i) => (
                        <div key={r.displayName} className="flex items-center gap-3 bg-white rounded-[8px] border-[2px] border-pf-dark px-3 py-2 shadow-[2px_2px_0_#1A1A2E]">
                          ...
                          <div className="w-20 h-2 bg-gray-200 rounded-full overflow-hidden">
                            <div className="h-full bg-pf-yellow rounded-full" style={{ width: `${(r.voteCount / maxVotes) * 100}%` }} />
                          </div>
                          <span className="text-sm font-bold text-pf-dark w-10 text-right">{r.voteCount}票</span>
